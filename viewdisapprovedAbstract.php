  ...
  <div class="row">
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="viewdisapprovedAbstract.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="reportStudent.php">
              <span data-feather="file-text"></span>
              See all Reports
            </a>
          </li>
    ...
    <?php
        $conn=mysqli_connect("localhost","root","","research_conclave20");
            ...
            $queryPoster = mysqli_query($conn,"select * from Poster where IsUnderReview = 3 ");
            $queryOral = mysqli_query($conn,"select * from Oral where IsUnderReview = 3 ");
        ...
        if (isset($_POST['assign_buttonP']))
    {
        ...
        header("Location: ./viewdisapprovedAbstract.php");
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Disapproved Abstracts</h1>        
      </div>
              ...
              $selectOption = "";
               ...
               while ($row = mysqli_fetch_array($queryPoster)) {
                  $name = $row['FirstName']." ".$row['MiddleName']." ".$row['LastName'];
                   ...
                   echo '<td align=center><button  type=submit  name=assign_buttonP value="';echo $row['PosterId']; echo '">Re-Assign</button></form></td>';
               ...
               while ($row = mysqli_fetch_array($queryOral)) {
                  $name = $row['FirstName']." ".$row['MiddleName']." ".$row['LastName'];
                   ...
                   echo "<td><select name = Oreviewer2_select><option>Choose...</option>".$selectOption."</select></td>";
                    echo '<td align=center><button  type=submit  name=assign_buttonO value="';echo $row['OralId']; echo '">Re-Assign</button></form></td>';
                   echo "</tr>";
               }
            ?>
