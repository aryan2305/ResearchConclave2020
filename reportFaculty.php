    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="reportFaculty.php">
              <span data-feather="file-text"></span>
              See all Reports
            </a>
          </li>          
      ...
      <h2>Poster Reports</h2>
        ...
        <?php
            ...
            while($row=mysqli_fetch_assoc($posterquery))
            {
                ...
                $avgGrade = ($row['Grade_1']+$row['Grade_2'])/2;  
                ...
                echo '<h6 class="card-title"> Grade1: '.$row['Grade_1'].'</h6>';
                ...
                echo '<h6 class="card-title"> Grade1: '.$row['Grade_2'].'</h6>';
                echo '<hr><h5 class="card-title"> Average Grade: '.$avgGrade.'</h5>';
                echo '</div></div>';
            }
            ?>
            <h2>Oral Reports</h2>
